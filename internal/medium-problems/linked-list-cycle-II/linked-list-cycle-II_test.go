...
func Test_HasCycle(t *testing.T) {
	tests := []struct {
		...
		{
			inputList:      &l.ListNode{Val: 1, Next: &l.ListNode{Val: 1, Next: &l.ListNode{Val: 1, Next: &l.ListNode{Val: 1, Next: &l.ListNode{Val: 1, Next: &l.ListNode{Val: 1, Next: &l.ListNode{Val: 1, Next: &l.ListNode{Val: 1, Next: nil}}}}}}}},
			expectedResult: false,
			cycleFrom:      -1,
		},
	}
